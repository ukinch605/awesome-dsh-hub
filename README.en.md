...
| --- | ---: |
| Plugins | **10093** |
| Monitored repos | 13574 |
| Total stars | 87,557 |
| Last updated | 2026-09-04 23:27:47.783 UTC |

### Categories

Web UI 1245 · Agent Capabilities 4603 · Coding & Engineering 772 · Messaging & Notifications 365 · Vision & Multimodal 732 · Browser & Web 505 · Skins & Fun 251 · Files & Data 1138 · Dev Tools & Tutorials 234 · Bundles & Distros 152 · Ecosystem Projects 96

### Top 10 Plugins

| # | Plugin | Stars | Type | Description |
| --- | --- | ---: | --- | --- |
| 1 | [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 7,076 | Agent Capabilities | dsh-routing-suite — injector + router-standard kit: install… |
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,865 | Dev Tools & Tutorials | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
| 3 | [liustack/modlens](https://github.com/liustack/modlens) | 3,863 | Vision & Multimodal | The first vision plugin for DeepSeek Harness, and the visio… |
...
| 5 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 3,183 | Agent Capabilities | The plugin market inside DeepSeek Harness — browse, search,… |
...
| 7 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,724 | Web UI | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,368 | Agent Capabilities | AgentTeams plugin for DeepSeek Harness |
...
| 10 | [superdesigndev/treg](https://github.com/superdesigndev/treg) | 1,187 | Messaging & Notifications | OpenRouter for agent tools. Join community here: https://di… |
