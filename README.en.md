...
| --- | ---: |
| Plugins | **1420** |
| Monitored repos | 2374 |
| Total stars | 9,363 |
| Last updated | 2026-08-14 21:00:16.632 UTC |

### Categories

Web UI 181 · Agent Capabilities 569 · Coding & Engineering 126 · Messaging & Notifications 55 · Vision & Multimodal 132 · Browser & Web 75 · Skins & Fun 45 · Files & Data 181 · Dev Tools & Tutorials 28 · Bundles & Distros 16 · Ecosystem Projects 12

### Top 10 Plugins

| # | Plugin | Stars | Type | Description |
| --- | --- | ---: | --- | --- |
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | 1,278 | Vision & Multimodal | The first vision plugin for DeepSeek Harness, and the visio… |
| 2 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 885 | Coding & Engineering | 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插… |
| 3 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 758 | Web UI | 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理 |
...
| 5 | [mnemon-dev/mnemon](https://github.com/mnemon-dev/mnemon) | 434 | Files & Data | LLM-supervised persistent memory for AI agents — graph-base… |
| 6 | [Nagi-ovo/dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 333 | Skins & Fun | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups for … |
| 7 | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 327 | Vision & Multimodal | 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜D… |
