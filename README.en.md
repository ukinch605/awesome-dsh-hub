...
| --- | ---: |
| Plugins | **1387** |
| Monitored repos | 2314 |
| Total stars | 9,253 |
| Last updated | 2026-08-14 18:59:15.212 UTC |

### Categories

Web UI 179 · Agent Capabilities 562 · Coding & Engineering 119 · Messaging & Notifications 50 · Vision & Multimodal 127 · Browser & Web 71 · Skins & Fun 45 · Files & Data 179 · Dev Tools & Tutorials 27 · Bundles & Distros 15 · Ecosystem Projects 13

### Top 10 Plugins

| # | Plugin | Stars | Type | Description |
| --- | --- | ---: | --- | --- |
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | 1,264 | Vision & Multimodal | The first vision plugin for DeepSeek Harness, and the visio… |
| 2 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 879 | Coding & Engineering | 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插… |
| 3 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 748 | Web UI | 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理 |
...
| 7 | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 324 | Vision & Multimodal | 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜D… |
