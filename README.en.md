...
| --- | ---: |
| Plugins | **9982** |
| Monitored repos | 13440 |
| Total stars | 85,951 |
| Last updated | 2026-09-03 21:26:56.452 UTC |

### Categories

Web UI 1223 · Agent Capabilities 4559 · Coding & Engineering 766 · Messaging & Notifications 361 · Vision & Multimodal 723 · Browser & Web 499 · Skins & Fun 250 · Files & Data 1123 · Dev Tools & Tutorials 232 · Bundles & Distros 151 · Ecosystem Projects 95

### Top 10 Plugins

| # | Plugin | Stars | Type | Description |
| --- | --- | ---: | --- | --- |
| 1 | [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 7,051 | Agent Capabilities | dsh-routing-suite — injector + router-standard kit: install… |
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,788 | Dev Tools & Tutorials | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
...
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3,299 | Web UI | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
| 5 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 3,117 | Agent Capabilities | The plugin market inside DeepSeek Harness — browse, search,… |
...
| 7 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,675 | Web UI | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,330 | Agent Capabilities | AgentTeams plugin for DeepSeek Harness |
| 9 | [bowenliang123/dsh-context](https://github.com/bowenliang123/dsh-context) | 1,264 | Browser & Web | The best DeepSeek Harness plugin for context insight and ma… |
