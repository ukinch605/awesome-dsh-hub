...
![Plugins](https://img.shields.io/badge/plugins-1944-4dabf7)
...
| --- | ---: |
| Plugins | **1944** |
| Monitored repos | 3134 |
| Total stars | 14,739 |
| Last updated | 2026-08-15 09:52:50.982 UTC |

### Categories

Web UI 267 · Agent Capabilities 767 · Coding & Engineering 169 · Messaging & Notifications 75 · Vision & Multimodal 178 · Browser & Web 100 · Skins & Fun 60 · Files & Data 247 · Dev Tools & Tutorials 45 · Bundles & Distros 19 · Ecosystem Projects 17

### Top 10 Plugins

| # | Plugin | Stars | Type | Description |
| --- | --- | ---: | --- | --- |
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | 1,566 | Vision & Multimodal | The first vision plugin for DeepSeek Harness, and the visio… |
| 2 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1,065 | Coding & Engineering | 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插… |
| 3 | [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) | 1,013 | Coding & Engineering | Make AI coding agents architecture-aware: baseline-first, e… |
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 936 | Web UI | 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理 |
| 5 | [sandbaseai/sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 581 | Agent Capabilities | Open-source CMA-compatible agent runtime for any model, wit… |
...
| 7 | [mnemon-dev/mnemon](https://github.com/mnemon-dev/mnemon) | 443 | Files & Data | LLM-supervised persistent memory for AI agents — graph-base… |
...
| 10 | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 390 | Vision & Multimodal | 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜D… |
