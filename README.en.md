...
| --- | ---: |
| Plugins | **4679** |
| Monitored repos | 6344 |
| Total stars | 81,349 |
| Last updated | 2026-09-03 01:35:44.956 UTC |

### Categories

Web UI 631 · Agent Capabilities 1885 · Coding & Engineering 392 · Messaging & Notifications 193 · Vision & Multimodal 372 · Browser & Web 257 · Skins & Fun 141 · Files & Data 582 · Dev Tools & Tutorials 116 · Bundles & Distros 64 · Ecosystem Projects 46
...
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,737 | Dev Tools & Tutorials | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
...
| 6 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2,785 | Messaging & Notifications | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回… |
| 7 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,622 | Web UI | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,302 | Agent Capabilities | AgentTeams plugin for DeepSeek Harness |
...
| 10 | [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) | 1,165 | Coding & Engineering | Make AI coding agents architecture-aware: baseline-first, e… |
