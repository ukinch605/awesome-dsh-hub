...
![Plugins](https://img.shields.io/badge/plugins-4616-4dabf7)
...
| --- | ---: |
| Plugins | **4616** |
| Monitored repos | 6239 |
| Total stars | 67,834 |
| Last updated | 2026-08-29 08:42:52.861 UTC |

### Categories

Web UI 648 · Agent Capabilities 1870 · Coding & Engineering 375 · Messaging & Notifications 192 · Vision & Multimodal 373 · Browser & Web 249 · Skins & Fun 133 · Files & Data 559 · Dev Tools & Tutorials 106 · Bundles & Distros 68 · Ecosystem Projects 43
...
| 2 | [liustack/modlens](https://github.com/liustack/modlens) | 3,748 | Vision & Multimodal | The first vision plugin for DeepSeek Harness, and the visio… |
| 3 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3,081 | Web UI | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
| 4 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 2,723 | Agent Capabilities | The plugin market inside DeepSeek Harness — browse, search,… |
| 5 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2,673 | Messaging & Notifications | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回… |
| 6 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,283 | Web UI | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 7 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,167 | Agent Capabilities | AgentTeams plugin for DeepSeek Harness |
| 8 | [bowenliang123/dsh-context](https://github.com/bowenliang123/dsh-context) | 1,154 | Browser & Web | The best DeepSeek Harness plugin for context insight and ma… |
| 9 | [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) | 1,147 | Coding & Engineering | Make AI coding agents architecture-aware: baseline-first, e… |
| 10 | [ysr666/dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1,019 | Vision & Multimodal | Eyes for text-only DeepSeek Harness agents: built-in free v… |
