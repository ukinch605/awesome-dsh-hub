...
![Plugins](https://img.shields.io/badge/plugins-9983-4dabf7)
...
| --- | ---: |
| 收录插件 / Plugins | **9983** |
| 监测仓库 / Monitored repos | 13438 |
| 累计 Star / Total stars | 85,898 |
| 最近更新 / Last updated | 2026-09-03 18:54:50.836 UTC |

### 分类构成 / Categories

Web UI 增强 1223 · Agent 能力 4559 · 编码开发 767 · 消息通讯 361 · 视觉与多模态 723 · 浏览器与网络 499 · 皮肤与娱乐 250 · 文件与数据 1123 · 开发工具与教程 232 · 合集与发行版 151 · 生态项目 95
...
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,787 | 开发工具与教程 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
...
| 5 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 3,116 | Agent 能力 | The plugin market inside DeepSeek Harness — browse, search,… |
...
| 7 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,674 | Web UI 增强 | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
