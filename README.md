...
| --- | ---: |
| 收录插件 / Plugins | **10183** |
| 监测仓库 / Monitored repos | 13686 |
| 累计 Star / Total stars | 88,571 |
| 最近更新 / Last updated | 2026-09-05 20:45:37.498 UTC |

### 分类构成 / Categories

Web UI 增强 1259 · Agent 能力 4646 · 编码开发 774 · 消息通讯 369 · 视觉与多模态 739 · 浏览器与网络 506 · 皮肤与娱乐 254 · 文件与数据 1151 · 开发工具与教程 234 · 合集与发行版 153 · 生态项目 98

### Top 10 插件 / Top Plugins

| # | 插件 / Plugin | Stars | 类型 / Type | 说明 / Description |
| --- | --- | ---: | --- | --- |
| 1 | [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 7,099 | Agent 能力 | dsh-routing-suite — injector + router-standard kit: install… |
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,940 | 开发工具与教程 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
...
| 5 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 3,247 | Agent 能力 | The plugin market inside DeepSeek Harness — browse, search,… |
...
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,387 | Agent 能力 | AgentTeams plugin for DeepSeek Harness |
| 9 | [bowenliang123/dsh-context](https://github.com/bowenliang123/dsh-context) | 1,296 | 浏览器与网络 | The best DeepSeek Harness plugin for context insight and ma… |
| 10 | [superdesigndev/treg](https://github.com/superdesigndev/treg) | 1,201 | 消息通讯 | OpenRouter for agent tools. Join community here: https://di… |
