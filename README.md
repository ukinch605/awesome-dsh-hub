...
| --- | ---: |
| 收录插件 / Plugins | **4635** |
| 监测仓库 / Monitored repos | 6287 |
| 累计 Star / Total stars | 78,998 |
| 最近更新 / Last updated | 2026-09-01 23:36:29.826 UTC |

### 分类构成 / Categories

Web UI 增强 640 · Agent 能力 1897 · 编码开发 371 · 消息通讯 186 · 视觉与多模态 375 · 浏览器与网络 254 · 皮肤与娱乐 122 · 文件与数据 560 · 开发工具与教程 113 · 合集与发行版 71 · 生态项目 46
...
| 7 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,559 | Web UI 增强 | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,260 | Agent 能力 | AgentTeams plugin for DeepSeek Harness |
