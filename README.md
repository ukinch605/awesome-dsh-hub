...
| --- | ---: |
| 收录插件 / Plugins | **1403** |
| 监测仓库 / Monitored repos | 2338 |
| 累计 Star / Total stars | 9,293 |
| 最近更新 / Last updated | 2026-08-14 19:39:32.327 UTC |

### 分类构成 / Categories

Web UI 增强 179 · Agent 能力 563 · 编码开发 124 · 消息通讯 50 · 视觉与多模态 130 · 浏览器与网络 73 · 皮肤与娱乐 45 · 文件与数据 183 · 开发工具与教程 28 · 合集与发行版 15 · 生态项目 13

### Top 10 插件 / Top Plugins

| # | 插件 / Plugin | Stars | 类型 / Type | 说明 / Description |
| --- | --- | ---: | --- | --- |
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | 1,271 | 视觉与多模态 | The first vision plugin for DeepSeek Harness, and the visio… |
| 2 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 881 | 编码开发 | 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插… |
| 3 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 753 | Web UI 增强 | 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理 |
...
| 7 | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 326 | 视觉与多模态 | 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜D… |
