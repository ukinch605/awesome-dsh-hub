...
![Plugins](https://img.shields.io/badge/plugins-9988-4dabf7)
...
| 累计 Star / Total stars | 85,992 |
| 最近更新 / Last updated | 2026-09-03 23:35:20.464 UTC |

### 分类构成 / Categories

Web UI 增强 1226 · Agent 能力 4562 · 编码开发 766 · 消息通讯 361 · 视觉与多模态 723 · 浏览器与网络 499 · 皮肤与娱乐 250 · 文件与数据 1123 · 开发工具与教程 232 · 合集与发行版 151 · 生态项目 95
...
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,789 | 开发工具与教程 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
...
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3,300 | Web UI 增强 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
...
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,331 | Agent 能力 | AgentTeams plugin for DeepSeek Harness |
