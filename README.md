...
| --- | ---: |
| 收录插件 / Plugins | **4584** |
| 监测仓库 / Monitored repos | 6197 |
| 累计 Star / Total stars | 67,723 |
| 最近更新 / Last updated | 2026-08-29 14:43:19.644 UTC |

### 分类构成 / Categories

Web UI 增强 638 · Agent 能力 1853 · 编码开发 384 · 消息通讯 190 · 视觉与多模态 363 · 浏览器与网络 250 · 皮肤与娱乐 132 · 文件与数据 558 · 开发工具与教程 107 · 合集与发行版 67 · 生态项目 42
...
| 2 | [liustack/modlens](https://github.com/liustack/modlens) | 3,752 | 视觉与多模态 | The first vision plugin for DeepSeek Harness, and the visio… |
| 3 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3,092 | Web UI 增强 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
| 4 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 2,751 | Agent 能力 | The plugin market inside DeepSeek Harness — browse, search,… |
| 5 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2,682 | 消息通讯 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回… |
| 6 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,308 | Web UI 增强 | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 7 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,180 | Agent 能力 | AgentTeams plugin for DeepSeek Harness |
| 8 | [bowenliang123/dsh-context](https://github.com/bowenliang123/dsh-context) | 1,161 | 浏览器与网络 | The best DeepSeek Harness plugin for context insight and ma… |
