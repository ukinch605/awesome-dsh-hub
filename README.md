...
| --- | ---: |
| 收录插件 / Plugins | **4645** |
| 监测仓库 / Monitored repos | 6265 |
| 累计 Star / Total stars | 75,897 |
| 最近更新 / Last updated | 2026-08-30 21:40:42.645 UTC |

### 分类构成 / Categories

Web UI 增强 646 · Agent 能力 1898 · 编码开发 378 · 消息通讯 186 · 视觉与多模态 375 · 浏览器与网络 255 · 皮肤与娱乐 127 · 文件与数据 559 · 开发工具与教程 109 · 合集与发行版 66 · 生态项目 46
...
| 3 | [liustack/modlens](https://github.com/liustack/modlens) | 3,774 | 视觉与多模态 | The first vision plugin for DeepSeek Harness, and the visio… |
