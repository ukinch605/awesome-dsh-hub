...
| --- | ---: |
| 收录插件 / Plugins | **4316** |
| 监测仓库 / Monitored repos | 5933 |
| 累计 Star / Total stars | 56,436 |
| 最近更新 / Last updated | 2026-08-27 02:17:29.532 UTC |

### 分类构成 / Categories

Web UI 增强 611 · Agent 能力 1756 · 编码开发 337 · 消息通讯 171 · 视觉与多模态 346 · 浏览器与网络 236 · 皮肤与娱乐 125 · 文件与数据 535 · 开发工具与教程 108 · 合集与发行版 55 · 生态项目 36

### Top 10 插件 / Top Plugins

| # | 插件 / Plugin | Stars | 类型 / Type | 说明 / Description |
| --- | --- | ---: | --- | --- |
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | 3,703 | 视觉与多模态 | The first vision plugin for DeepSeek Harness, and the visio… |
| 2 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2,971 | Web UI 增强 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
| 3 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2,599 | 消息通讯 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回… |
| 4 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 2,511 | Agent 能力 | The plugin market inside DeepSeek Harness — browse, search,… |
| 5 | [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) | 1,134 | 编码开发 | Make AI coding agents architecture-aware: baseline-first, e… |
| 6 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,091 | Web UI 增强 | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 7 | [bowenliang123/dsh-context](https://github.com/bowenliang123/dsh-context) | 1,080 | 浏览器与网络 | The best DeepSeek Harness plugin for context insight and ma… |
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,078 | Agent 能力 | AgentTeams plugin for DeepSeek Harness |
| 9 | [ysr666/dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 998 | 视觉与多模态 | Eyes for text-only DeepSeek Harness agents: built-in free v… |
| 10 | [xmanrui/dsh-im](https://github.com/xmanrui/dsh-im) | 890 | 消息通讯 | 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、企业微信、QQ、Slack… |
