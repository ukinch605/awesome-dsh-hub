...
| --- | ---: |
| 收录插件 / Plugins | **1944** |
| 监测仓库 / Monitored repos | 3134 |
| 累计 Star / Total stars | 14,739 |
| 最近更新 / Last updated | 2026-08-15 09:52:50.982 UTC |

### 分类构成 / Categories

Web UI 增强 267 · Agent 能力 767 · 编码开发 169 · 消息通讯 75 · 视觉与多模态 178 · 浏览器与网络 100 · 皮肤与娱乐 60 · 文件与数据 247 · 开发工具与教程 45 · 合集与发行版 19 · 生态项目 17

### Top 10 插件 / Top Plugins

| # | 插件 / Plugin | Stars | 类型 / Type | 说明 / Description |
| --- | --- | ---: | --- | --- |
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | 1,566 | 视觉与多模态 | The first vision plugin for DeepSeek Harness, and the visio… |
| 2 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1,065 | 编码开发 | 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插… |
| 3 | [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) | 1,013 | 编码开发 | Make AI coding agents architecture-aware: baseline-first, e… |
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 936 | Web UI 增强 | 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理 |
| 5 | [sandbaseai/sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 581 | Agent 能力 | Open-source CMA-compatible agent runtime for any model, wit… |
...
| 7 | [mnemon-dev/mnemon](https://github.com/mnemon-dev/mnemon) | 443 | 文件与数据 | LLM-supervised persistent memory for AI agents — graph-base… |
...
| 10 | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 390 | 视觉与多模态 | 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜D… |
