...
| --- | ---: |
| 收录插件 / Plugins | **10086** |
| 监测仓库 / Monitored repos | 13559 |
| 累计 Star / Total stars | 87,435 |
| 最近更新 / Last updated | 2026-09-04 18:35:48.483 UTC |

### 分类构成 / Categories

Web UI 增强 1242 · Agent 能力 4600 · 编码开发 771 · 消息通讯 365 · 视觉与多模态 733 · 浏览器与网络 505 · 皮肤与娱乐 251 · 文件与数据 1137 · 开发工具与教程 234 · 合集与发行版 152 · 生态项目 96

### Top 10 插件 / Top Plugins

| # | 插件 / Plugin | Stars | 类型 / Type | 说明 / Description |
| --- | --- | ---: | --- | --- |
| 1 | [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 7,073 | Agent 能力 | dsh-routing-suite — injector + router-standard kit: install… |
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,860 | 开发工具与教程 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
...
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3,330 | Web UI 增强 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
| 5 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 3,178 | Agent 能力 | The plugin market inside DeepSeek Harness — browse, search,… |
...
| 7 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,723 | Web UI 增强 | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
...
| 10 | [superdesigndev/treg](https://github.com/superdesigndev/treg) | 1,182 | 消息通讯 | OpenRouter for agent tools. Join community here: https://di… |
