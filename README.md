...
| --- | ---: |
| 收录插件 / Plugins | **4252** |
| 监测仓库 / Monitored repos | 5857 |
| 累计 Star / Total stars | 55,676 |
| 最近更新 / Last updated | 2026-08-26 14:32:01.986 UTC |

### 分类构成 / Categories

Web UI 增强 573 · Agent 能力 1771 · 编码开发 347 · 消息通讯 175 · 视觉与多模态 336 · 浏览器与网络 220 · 皮肤与娱乐 119 · 文件与数据 519 · 开发工具与教程 102 · 合集与发行版 55 · 生态项目 35

### Top 10 插件 / Top Plugins

| # | 插件 / Plugin | Stars | 类型 / Type | 说明 / Description |
| --- | --- | ---: | --- | --- |
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | 3,689 | 视觉与多模态 | The first vision plugin for DeepSeek Harness, and the visio… |
| 2 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2,960 | Web UI 增强 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
| 3 | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2,585 | 消息通讯 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回… |
| 4 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 2,488 | Agent 能力 | The plugin market inside DeepSeek Harness — browse, search,… |
...
| 6 | [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1,066 | Web UI 增强 | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。Q… |
| 7 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,057 | Agent 能力 | AgentTeams plugin for DeepSeek Harness |
| 8 | [bowenliang123/dsh-context](https://github.com/bowenliang123/dsh-context) | 1,052 | 浏览器与网络 | The best DeepSeek Harness plugin for context insight and ma… |
| 9 | [ysr666/dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 990 | 视觉与多模态 | Eyes for text-only DeepSeek Harness agents: built-in free v… |
| 10 | [xmanrui/dsh-im](https://github.com/xmanrui/dsh-im) | 878 | 消息通讯 | 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、企业微信、QQ、Slack… |
