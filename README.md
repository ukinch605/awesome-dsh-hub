...
![Plugins](https://img.shields.io/badge/plugins-10093-4dabf7)
...
| --- | ---: |
| 收录插件 / Plugins | **10093** |
| 监测仓库 / Monitored repos | 13574 |
| 累计 Star / Total stars | 87,557 |
| 最近更新 / Last updated | 2026-09-04 23:27:47.783 UTC |

### 分类构成 / Categories

Web UI 增强 1245 · Agent 能力 4603 · 编码开发 772 · 消息通讯 365 · 视觉与多模态 732 · 浏览器与网络 505 · 皮肤与娱乐 251 · 文件与数据 1138 · 开发工具与教程 234 · 合集与发行版 152 · 生态项目 96

### Top 10 插件 / Top Plugins

| # | 插件 / Plugin | Stars | 类型 / Type | 说明 / Description |
| --- | --- | ---: | --- | --- |
| 1 | [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 7,076 | Agent 能力 | dsh-routing-suite — injector + router-standard kit: install… |
| 2 | [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6,865 | 开发工具与教程 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · E… |
| 3 | [liustack/modlens](https://github.com/liustack/modlens) | 3,863 | 视觉与多模态 | The first vision plugin for DeepSeek Harness, and the visio… |
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3,332 | Web UI 增强 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open s… |
| 5 | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | 3,183 | Agent 能力 | The plugin market inside DeepSeek Harness — browse, search,… |
...
| 8 | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1,368 | Agent 能力 | AgentTeams plugin for DeepSeek Harness |
...
| 10 | [superdesigndev/treg](https://github.com/superdesigndev/treg) | 1,187 | 消息通讯 | OpenRouter for agent tools. Join community here: https://di… |
